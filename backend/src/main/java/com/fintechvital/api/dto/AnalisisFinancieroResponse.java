...
@JsonPropertyOrder({
        ...
        "recomendaciones_detalle", "moneda", "idioma", "modelo_version", "analizado_en", "id"
})
...
public record AnalisisFinancieroResponse(
        ...
        /**
         * Id del analisis GUARDADO (`POST /api/v1/analisis` y `GET /analisis/{id}`).
         *
         * Va null en el endpoint del enunciado, que no persiste nada, y con
         * `default-property-inclusion=non_null` ni siquiera se serializa: la
         * respuesta que ve el jurado sigue siendo exactamente la misma. Va el
         * ULTIMO y fuera de @JsonPropertyOrder por lo mismo.
         */
        @Schema(description = "Solo en el analisis persistido; ausente en el endpoint del enunciado.")
        String id
) {
